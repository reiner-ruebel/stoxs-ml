from typing import Any, get_args, get_origin, Optional, Type, Union
...
class Utils:
    ...
    @staticmethod
    def flat_field_is_optional(field_type: Type[Optional[Any]]) -> bool:
        """
...
#        field_type = t.get_type_hints(cls).get(field_name, None)
        ...
        if origin is Union or origin is UnionType: # supports Optional[str] and str | None
